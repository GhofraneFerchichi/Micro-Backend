...
import com.example.usermicroservice.security.jwt.JwtAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests().antMatchers("/**").permitAll().
                ...
                antMatchers("/internal/**").hasRole(Role.ADMIN.name()).
                antMatchers("/api/checkout/**").permitAll()
                .antMatchers("/api/internal/**").hasRole(String.valueOf(Role.ADMIN))
